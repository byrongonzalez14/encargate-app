    ...
    <div id="beneficios" class="container mx-auto px-5">
        <section class="py-16">
            <div class="w-4/5 md:w-3/5 mx-auto">
                ...
                <p class="text-theme-grayish-blue text-center mt-7 font-theme-content text-lg">En Encárgate, te ayudamos a conseguir más clientes sin perder tiempo buscándolos. Tus servicios se sincronizan entre dispositivos para que puedas atender solicitudes, agendar tareas y seguir tu trabajo desde donde estés.</p>
            </div>
