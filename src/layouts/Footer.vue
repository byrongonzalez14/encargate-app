...
<template>
    <!-- Footer Start -->
    <footer class="bg-[#c4471c] py-10">
        <div class="container mx-auto px-5">
            <div class="grid md:grid-cols-2">
                <div class="flex flex-col md:flex-row md:space-x-12 items-center">
                    <div class="mb-10 md:mb-0">
                        <img src="/public/images/logo-encargate-footer.png" alt="Logo encárgate" />
                    </div>
                    <ul
                        ...
                        <li class="uppercase text-white hover:text-theme-secondary transition duration-200">
                            <a href="#beneficios" v-smooth-scroll>Beneficios</a>
                        </li>
                        <li class="uppercase text-white hover:text-theme-secondary transition duration-200">
                            <a href="#preguntasfrecuentes" v-smooth-scroll>Preguntas frecuentes</a>
                        </li>
                        <li class="uppercase text-white hover:text-theme-secondary transition duration-200">
                            <a href="#subscribe" v-smooth-scroll>Suscríbete</a>
                        </li>
                    </ul>
                </div>
