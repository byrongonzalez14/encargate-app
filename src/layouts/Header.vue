...
<template>
    ...
    <div class="container mx-auto px-5">
        <header class="flex justify-between py-4 items-center">
            <div>
                <a href="/"><img src="/public/images/logo-encargate-completo.png" alt="logo encargate"></a>
            </div>
            ...
            <nav class="flex justify-end flex-col md:flex-row">
                ...
                <ul
                    ...
                    <li class="uppercase hover:text-theme-secondary transition duration-200"><a href="#beneficios"
                            v-smooth-scroll>Beneficios</a></li>
                    <li class="uppercase hover:text-theme-secondary transition duration-200"><a
                            href="#preguntasfrecuentes" v-smooth-scroll>Preguntas frecuentes</a></li>
                    <li class="uppercase hover:text-theme-secondary transition duration-200"><a href="#subscribe"
                            v-smooth-scroll>Suscríbete</a></li>
                    <li
                        ...
                        <a href="#download-section" v-smooth-scroll>Únete</a>
                    </li>
                </ul>
            </nav>
        </header>
        ...
        <div v-show="mobileNav">
            <div
                ...
                <div class="flex justify-between items-center">
                    <img src="/public/images/logo-encargate-footer.png" alt="Logo">
                ...
                <div class="flex justify-center items-end h-52">
                    <ul class="flex space-x-8">
                        ...
                        <li>
                            <svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" fill="currentColor"
                                class="bi bi-instagram text-white hover:text-theme-secondary transition duration-200 cursor-pointer"
                                viewBox="0 0 16 16">
                                <path
